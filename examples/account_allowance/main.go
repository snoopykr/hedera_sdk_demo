...
func main() {
	...
	operatorAccountID, err := hedera.AccountIDFromString("0.0.2947767")
	if err != nil {
		panic(fmt.Sprintf("%v : error converting string to AccountID", err))
	}

	// Retrieving operator key from environment variable OPERATOR_KEY
	operatorKey, err := hedera.PrivateKeyFromString("302e020100300506032b6570042204207594aaac2f09a87d3947e3a04688b0f19f629dfb23a9021008643aaf5ea9350b")
	if err != nil {
